                  ...
                  (Project
                    (GroupBy
                      (Project
                        (Join
                          (Join
                            (Filter ,(quote ,customer) (Equal c_mktsegment "BUILDING"))
                            (keys c_custkey)
           ...
           (begin
             ...
             (boss-run
               `(Name
                  (Project
                    (Join
                      (Filter ,(quote ,orders) (And (GreaterEqual o_orderdate ,lo%)
                                                     (Less o_orderdate ,hi%)))
                      (keys o_custkey)
                          ...
                          (Join
                            (Join
                              (Join
                                ...
                                (keys l_suppkey)
                                ,(quote ,supplier) (keys s_suppkey))
                              (keys l_orderkey)
                              (Join ,(quote ,orders) (keys o_custkey) ,(quote ,customer) (keys c_custkey))
                              (keys o_orderkey))
                            (keys s_nationkey)
                          ...
                          (Join
                            (Join
                              (Join
                                ...
                                (keys o_orderkey)
                                ,(quote ,lineitem) (keys l_orderkey))
                              (keys l_partkey)
                            ...
                            (Join
                              (Filter ,(quote ,orders)
                                      (And (GreaterEqual o_orderdate ,lo%)
                                           (Less o_orderdate ,hi%)))
                              (keys o_custkey)
                              ,(quote ,customer) (keys c_custkey))
                            (keys o_orderkey)
                            (Filter ,(quote ,lineitem) (Equal l_returnflag "R"))
                            (keys l_orderkey))
                          (keys c_nationkey)
                          ,(quote ,nation) (keys n_nationkey))
               ...
               `(Name
                  (Filter
                    (GroupBy
                      (Project
                        (Join
                          ,(quote ,partsupp) (keys ps_suppkey)
                          (Join ,(quote ,supplier) (keys s_nationkey)
                 ...
                 (GroupBy
                   (Project
                     (AntiJoin
                       (Join
                         (Join
                           ;; Project renames l_orderkey_l back to l_orderkey for the semi-join.
                           (Project
